	...
	<div class="main">
		<div class="main-shrink">
			...
			<div class="order-history-header">
				<div class="order-history-header-shrink">Order History</div>
				<div class="order-history-description-shrink">
					<div class="order-history-description-col">Product Image</div>
					<div class="order-history-description-col">Product Name</div>
					<div class="order-history-description-col">Price</div>
					<div class="order-history-description-col">Date Of Purchase</div>
				</div>
			</div>
			<div class="order-history-header">
				<div class="order-history-product-shrink">
					<div class="order-history-product-col"><img src="images/apparels.jpg"></div>
					<div class="order-history-product-col"><p>Product Name</p></div>
					<div class="order-history-product-col"><p>Price</p></div>
					<div class="order-history-product-col"><p>Date Of Purchase</p></div>
				</div>
			</div>
