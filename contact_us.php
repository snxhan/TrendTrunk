			...
			<div class="contact-description">
				<div class="contact-description-shrink">
					<div class="contact-description-row">
						<div class="contact-description-col">Email : </div>
						<div class="contact-description-col"><input class="contact-description-input" placeholder="contact-us@shopname.com"></div>
					</div>
					<div class="contact-description-row"><br></div>
					<div class="contact-description-row">
						<div class="contact-description-col">Phone :</div>
						<div class="contact-description-col"><input class="contact-description-input" placeholder="+65 (Singapore Registered Numbers Only)"></div>
					</div>
					<div class="contact-description-row"><br></div>
					<div class="contact-description-row">
						<div class="contact-description-col">Working Hours :</div>
						<div class="contact-description-col"><input class="contact-description-input" placeholder="Eg, 9AM - 5PM"></div>
					</div>
					<div class="contact-description-row"><br></div>
					<div class="contact-description-row">
						<div class="contact-description-col">Office Location :</div>
						<div class="contact-description-col"><input class="contact-description-input" placeholder="Singapore Address Only"></div>
					</div>
				</div>
			</div>
			<div class="contact-header">
				<div class="contact-header-shrink">Drop Us An Enquiry!</div>
			</div>
			<div class="contact-description-shrink">
				<div class="contact-description-row">
					<div class="contact-description-col"><textarea class="contact-description-enquiry" placeholder="Ask anything! :)"></textarea></div>
				</div>
				<div class="contact-description-row"><br></div>
				<div class="contact-description-row">
					<div class="contact-description-col"><button class="enquiry-button" onclick="window.location.href = 'index.php?page=contact_us_results'"> Submit Form</button></div>
				</div>
			</div>
		</div>
	</div>
