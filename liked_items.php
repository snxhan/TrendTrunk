...
<body>
	...
	<div class="main">
		<div class="main-shrink">
			...
			<div class="liked-items-header">
				<div class="liked-items-header-shrink">Liked Items	</div>
			</div>
			<div class="row">
				<div class="col-6">
					<a href="product.html"><img src="images/apparels.jpg"></a>
					<h2>Charizard Shirt</h2>
					<p>$129$</p>
					<button class="move-to-cart">Move To Cart</button>
					<button class="remove-liked-item"><img src="images/trash-icon.png"></button>
				</div>
			</div>
		</div>
	</div>
